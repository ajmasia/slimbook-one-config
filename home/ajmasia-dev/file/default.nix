...

{
  ...
  # Enable nest line when use xmonad icons
  # ".xmonad/icons".source = ../../../assets/icons/xmonad;
  # User face icon don't works
  # ".face".source = ../../../assets/user-avatars/ajmasia-avatar_apple-emoji_250x250.png;
}
